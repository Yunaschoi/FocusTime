...
import com.example.focustime.Fragement.Camera2BasicFragment;
...
public class CameraActivity extends AppCompatActivity {
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader imageReader) {
            ...
            File mFile = new File(getExternalFilesDir(null), "profileImage.jpg"); // 내 앱의 리소스 경로
            ...
            Intent resultIntent = new Intent();       // 사진을 찍으면 인텐트로 사진주소값을 넘겨줌
            resultIntent.putExtra("profilePath", mFile.toString());
            setResult(Activity.RESULT_OK, resultIntent);

            camera2BasicFragment.closeCamera(); // 카메라를 꺼준다
            finish();
        }
    };
