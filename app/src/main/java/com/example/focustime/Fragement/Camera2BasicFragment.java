...
package com.example.focustime.Fragement;
...
import com.example.focustime.View.AutoFitTextureView;
...
public class Camera2BasicFragment extends Fragment
    ...
    */
    ...
    public void setmOnImageAvailableListener(ImageReader.OnImageAvailableListener mOnImageAvailableListener) {              // Listener 를 프래그먼트에 등록해준다
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                                               @NonNull CaptureRequest request,
                                               @NonNull TotalCaptureResult result) {
                    showToast("Saved: " + mFile);   // 사진 촬영시 나타나는 매시지
    ...
    private static class ImageUpLoader implements Runnable {
        ...
        public void run() {
            ...
            FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser(); // 사용자 Uid
            ...
            uploadTask.addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception exception) {     // 업로드 성공했을 떄 로그
                    // Handle unsuccessful uploads
                    Log.e("실패","실패");
                }
            }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                @Override
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {        //업로드 실패했을 때 로그
